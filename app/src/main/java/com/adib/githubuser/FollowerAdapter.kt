...
var followerFilter = ArrayList<User>()

class FollowerAdapter (private var listUser: ArrayList<User>) : RecyclerView.Adapter<FollowerAdapter.ListViewHolder>() {

    init {
        followerFilter = listUser
    }
